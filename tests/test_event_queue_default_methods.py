...
class MockEventQueue(EventQueue[str]):
    ...
    async def subscribe(self, subscriber, check_subscriber_unique=False, from_index=None):
        pass
    ...
    async def search_events(self, page_id=None, limit=100, created_at__gte=None, created_at__lte=None):
        """Abstract method implementation"""
        pass
    ...
    async def search_results(self, page_id=None, limit=100, event_id__eq=None, worker_id__eq=None, created_at__gte=None, created_at__lte=None):
        """Abstract method implementation"""
        pass
    ...
    async def search_claims(self, page_id=None, limit=100, worker_id__eq=None, created_at__gte=None, created_at__lte=None):
        """Abstract method implementation"""
        pass
...
class TestEventQueueDefaultMethods:
    ...
    async def test_batch_get_subscriptions_success(self, event_queue):
        ...
        result = await event_queue.batch_get_subscriptions([subscriber_id1, subscriber_id2])
    ...
    async def test_count_subscriptions(self, event_queue):
        ...
        page1 = Page(items=[Subscription(id=uuid4(), subscriber=MockSubscriber()) for _ in range(3)], next_page_id="page2")
        page2 = Page(items=[Subscription(id=uuid4(), subscriber=MockSubscriber()) for _ in range(2)], next_page_id=None)
    ...
    async def test_count_claims(self, event_queue):
        ...
        page1 = Page(items=[Claim(id="claim1", worker_id=uuid4(), created_at=datetime.now()) for _ in range(3)], next_page_id="page2")
        page2 = Page(items=[Claim(id="claim2", worker_id=uuid4(), created_at=datetime.now()) for _ in range(2)], next_page_id=None)
        
        async def mock_search_claims(page_id=None, limit=100, worker_id__eq=None, created_at__gte=None, created_at__lte=None):
            if page_id is None:
                return page1
            elif page_id == "page2":
                return page2
    ...
    async def test_batch_get_results_success(self, event_queue):
        ...
        result_id1 = uuid4()
        result_id2 = uuid4()
        result1 = EventResult(id=result_id1, event_id=1, worker_id=uuid4(), success=True, created_at=datetime.now())
        result2 = EventResult(id=result_id2, event_id=2, worker_id=uuid4(), success=True, created_at=datetime.now())
    ...
    async def test_count_events(self, event_queue):
        ...
        page1 = Page(items=[QueueEvent(id=i, payload=f"test{i}", created_at=datetime.now()) for i in range(3)], next_page_id="page2")
        page2 = Page(items=[QueueEvent(id=i, payload=f"test{i}", created_at=datetime.now()) for i in range(3, 5)], next_page_id=None)
        
        async def mock_search_events(page_id=None, limit=100, created_at__gte=None, created_at__lte=None):
            if page_id is None:
                return page1
            elif page_id == "page2":
                return page2
    ...
    async def test_count_results(self, event_queue):
        ...
        page1 = Page(items=[EventResult(id=uuid4(), event_id=i, worker_id=uuid4(), success=True, created_at=datetime.now()) for i in range(3)], next_page_id="page2")
        page2 = Page(items=[EventResult(id=uuid4(), event_id=i, worker_id=uuid4(), success=True, created_at=datetime.now()) for i in range(3, 5)], next_page_id=None)
        
        async def mock_search_results(page_id=None, limit=100, event_id__eq=None, worker_id__eq=None, created_at__gte=None, created_at__lte=None):
            if page_id is None:
                return page1
            elif page_id == "page2":
                return page2
